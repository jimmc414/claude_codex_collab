...
register_stage(
    Stage(
        ...
        instructions=dedent(
            ...
            6. Record progress with `python -m codex.pipeline_cli checklist requirements_loop set`
               so the CLI knows which checklist items have passed.
            """
        ).strip(),
...
register_stage(
    Stage(
        ...
        instructions=dedent(
            ...
            4. Track checklist status with `python -m codex.pipeline_cli checklist requirements_doc set`.
            5. Use `python -m codex.pipeline_cli capture requirements_doc` to store the approved document.
            """
        ).strip(),
        system_prompt_template="""
...
register_stage(
    Stage(
        ...
        instructions=dedent(
            ...
            4. Update checklist status with `python -m codex.pipeline_cli checklist architecture_doc set`.
            5. Save the approved artifact via `python -m codex.pipeline_cli capture architecture_doc`.
            """
        ).strip(),
        system_prompt_template="""
...
register_stage(
    Stage(
        ...
        instructions=dedent(
            ...
            4. Mark checklist progress using `python -m codex.pipeline_cli checklist implementation_doc set`.
            5. Store the artifact using `python -m codex.pipeline_cli capture implementation_doc` once approved.
            """
        ).strip(),
        system_prompt_template="""
...
register_stage(
    Stage(
        ...
        instructions=dedent(
            ...
            6. Reflect checklist status with `python -m codex.pipeline_cli checklist code_build set` as evidence accrues.
            """
        ).strip(),
        system_prompt_template="""
...
register_stage(
    Stage(
        ...
        instructions=dedent(
            ...
            5. Update review readiness with `python -m codex.pipeline_cli checklist review_loop set`.
            """
        ).strip(),
        system_prompt_template="""
...
register_stage(
    Stage(
        ...
        instructions=dedent(
            ...
            4. Confirm checklist completion with `python -m codex.pipeline_cli checklist ready_gate set`.
            """
        ).strip(),
        system_prompt_template="""
